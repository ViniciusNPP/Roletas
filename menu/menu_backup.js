...
roletas.addEventListener('contextmenu', function(e) {
    ...
    let dados = CM.contextMenu(e, menu_options);
...
pronto.addEventListener('click', () => {
    if (input_nome_roleta.value){
        ...
        estado.elementoAtual.querySelector('span').textContent = input_nome_roleta.value;
        const nome_exibido = estado.elementoAtual.querySelector('h3');
